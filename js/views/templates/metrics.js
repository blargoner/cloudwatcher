...
function program1(depth0,data) {
  ...
  buffer += "\n                    <th>Name</th>\n                </tr>\n            </thead>\n            <tbody>\n                ";
  stack1 = helpers.each.call(depth0, depth0.Metrics, {hash:{},inverse:self.noop,fn:self.program(4, program4, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n            </tbody>\n        </table>\n    </section>\n";
  return buffer;
  }
...
function program4(depth0,data) {
  ...
  var buffer = "", stack1;
  buffer += "\n                    <tr>\n                        ";
  stack1 = helpers.each.call(depth0, depth0.Dimensions, {hash:{},inverse:self.noop,fn:self.program(5, program5, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n                        <td>";
