...
(function() {
     ...
     */
    AWSCloudWatchClient = function(accessKey, secretKey, XHR) {
        accessKey = accessKey || '';
        secretKey = secretKey || '';
     ...
     * @param {Function} callback callback function
     */
    AWSCloudWatchClient.prototype._do = function(action, data, callback) {
        _request(_url(_sign(_parametrize(action, data), this._signer)), callback, this._XHR);
    };
    ...
    AWSCloudWatchClient.prototype.listMetrics = function(data, callback) {
        this._do(LIST_METRICS, data, function(response) {
            callback(response && response.ListMetricsResponse && response.ListMetricsResponse.ListMetricsResult);
        });
    };
